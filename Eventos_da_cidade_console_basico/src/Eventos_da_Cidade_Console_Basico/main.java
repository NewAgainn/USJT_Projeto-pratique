...
public class main {
    ...
    public static void cadastro_usuario() {
        ...
        String dataNascimentoCalculo = ano + "-" + mes + "-" + dia; // para o calculo de idade precisa ser no formato
                                                                    // "yyyy-MM-dd"
    ...
    public static void deletar_evento() {
        ...
        // Tenta abrir o arquivo de eventos para leitura e o arquivo temporário para
        // escrita
        try (BufferedReader reader = new BufferedReader(new FileReader(arquivoAtual));
            ...
            while ((linha_atual = reader.readLine()) != null) {
                ...
                // Se não estiver dentro do bloco do evento a ser excluído, escreve a linha no
                // arquivo temporário
                if (!isEventoEncontrado) {
                    // Se a última linha excluída foi um separador e a linha atual está vazia, pula
                    // a linha
        ...
        // Após a leitura e escrita, tenta excluir o arquivo original e renomear o
        // temporário para o original
    ...
    public class Lista_eventos {
        ...
        public static void eventos_inicial() {
            ...
            try {
                ...
                // Determina o número de eventos a serem impressos (no caso o máximo é definido
                // como 3)
